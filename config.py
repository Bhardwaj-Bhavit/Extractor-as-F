...
class Config(object):
    ...
    DB_URL = "mongodb+srv://knight_rider:GODGURU12345@knight.jm59gu9.mongodb.net/?retryWrites=true&w=majority"
    # Database ka naam
    DB_NAME = "MY_BOT_DB"
    ...
    THUMB_URL = "https://envs.sh/99V.jpg" #Replace by with your Thumb URL
    # API host ka URL
